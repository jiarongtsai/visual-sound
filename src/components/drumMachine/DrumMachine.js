...
const config = {
  ...
  samples: {
    Kick: "../../asset/sounds/kick.wav",
    Sub1: "../../asset/sounds/bass.wav",
    Sub2: "../../asset/sounds/sub.wav",
    Snare: "../../asset/sounds/snare.wav",
    Clap: "../../asset/sounds/clap.wav",
    HiHat: "../../asset/sounds/hat2.wav",
    OpenHiHat: "../../asset/sounds/openhihat.wav",
  },
};
